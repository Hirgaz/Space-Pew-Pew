...
[ "__emscripten_thread_init", "__emscripten_thread_exit", "__emscripten_thread_crashed", "__emscripten_thread_mailbox_await", "__emscripten_tls_init", "_pthread_self", "checkMailbox", "establishStackSpace", "invokeEntryPoint", "PThread", "__Z14godot_web_mainiPPc", "___indirect_function_table", "_main", "onRuntimeInitialized" ].forEach(prop => {
...
wasmBinaryFile = "godot.web.template_release.wasm32.disable_3d.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker() {
  var worker;
  var pthreadMainJs = locateFile("godot.web.template_release.wasm32.disable_3d.worker.js");
